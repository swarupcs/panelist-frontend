...
// FIX: removed userId — backend derives it from the JWT token (AUTH-1 fix)
...
// FIX: removed userId — backend derives it from the JWT token (AUTH-2 fix)
...
// Full per-question result returned by GET /:sessionId/results
